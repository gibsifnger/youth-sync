...
INPUT_PATH = "A_policy/policy_master_20260421.csv"
OUTPUT_CSV = "A_policy/policy_master_v2.csv"
OUTPUT_META = "A_policy/policy_metadata.json"
...
# 정책 1건 = 1row 유지 + 같은 정책명/기관 기준 1차 중복 제거
